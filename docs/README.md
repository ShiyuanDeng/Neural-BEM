...
| [Laurent](iterations/laurent/README.md) | What does a node-free Laurent/Fourier coefficient representation give the inverse, and what does it cost? | LAU-001 COMPLETE: `STRUCTURE_ONLY` — derivative-aware retention holds at 0.30 on both noncircular fixtures; forward-only selection destroys derivatives; no measured saving | Interpret [iteration 02](iterations/laurent/iteration_02/01_results.md); the named next diagnostic is a structured sparse assembly at matched quality | LAU-001 |
