...
| [Laurent](iterations/laurent/README.md) | What does a node-free Laurent/Fourier coefficient representation give the inverse, and what does it cost? | LAU-004 COMPLETE: protected spans lower rank 80→56 / 120→112; 42/42 guarded deliveries pass; compact nonanchor reuse target fails | [Priority review](iterations/laurent/iteration_06/02_proposals/01_outsider_priority_review.md) recommends parking generic compression and prioritizing inverse information; user direction pending | LAU-001, LAU-001-R1, LAU-002, LAU-003, LAU-004 |
| [Speed-up](iterations/speedup/README.md) | Where does the inverse spend its time, and which cost can be removed while preserving recovery? | SPD-007: compiled + reciprocal + readiness promoted to the full-inverse default | [Promotion and validation](iterations/speedup/iteration_07/01_results.md); geometry-validation cost is next | SPD-001, SPD-002, SPD-004–007 |
...
checks. [TOP-018](../results/validation/topology/TOP-018-20260915-resolution-qualified-pair/README.md)
has now completed that comparison: both schedules qualify at 256/512, F recovers
at 0.00167644 mm boundary error, and S fails at 11.793168 mm. The reporting-only
repair and failed worker exits are retained in the bundle; no numerical work was
repeated. No broader controller promotion or successor is authorized.
