...
> [`validation_change_log.md`](../reports/validation_change_log.md) and update
> [`current_architecture.md`](../reports/architecture_snapshot_2026-09-06.md) only when behavior is
> actually live.
...
> [`results/ordered_boundary_nystrom/`](../../results/validation/ordered_boundary_nystrom/README.md).
...
The [follow-up evidence](../reports/sdf_kress_followup_2026-09-06.md) passes fixed-node FD,
...
- Corners: piecewise-smooth components, explicit corner nodes, graded panels,
  ...
  in [`legacy/square_target_oracle_options.md`](square_target_oracle_options.md).
