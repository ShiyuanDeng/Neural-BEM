...
Jacobian. See [ownership](inverse_development_through_2026-09-06.md) and
...
The [2026-09-04 radial-continuation K5 run](../../results/inverse/radial_fourier/mlp-radial-continuation-k5-ellipse-to-star-kress-20260904/metrics.json)
