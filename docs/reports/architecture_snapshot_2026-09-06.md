...
[QBX closure](../legacy/qbx_closure.md) owns that decision, and the
[ordered-boundary plan](../legacy/ordered_boundary_nystrom_plan.md) owns future tasks.
The implemented low-dimensional MOD/Kress inverse is specified in
[`solver_neutral_inverse.md`](inverse_development_through_2026-09-06.md).
...
limitations are in [`solver_neutral_inverse.md`](inverse_development_through_2026-09-06.md).
...
6. The dated five-shape solver/QBX closeout report in
   [`../results/solver_comparisons/legacy/qbx-closeout-20260901/aggregate_metrics.md`](../../results/legacy/solver_experiments/qbx-closeout-20260901/aggregate_metrics.md).
...
and gates are in
[`ordered_boundary_nystrom_plan.md`](../legacy/ordered_boundary_nystrom_plan.md); the
architectural reason for leaving QBX/kdiff is in
[`qbx_closure.md`](../legacy/qbx_closure.md).
...
| Ordered-curve forward peer | `solvers/gpr_bem_kress/`, [`gpr_bem_kress_implementation.md`](../reference/gpr_bem_kress_implementation.md) |
| Ordered-curve solver evidence | `pytest/gpr_bem_kress/`, [`../results/ordered_boundary_nystrom/README.md`](../../results/validation/ordered_boundary_nystrom/README.md) |
| Legacy MOD neural adjoint/inverse | `solvers/gpr_bem_mod/ibim_tmz_adjoint.py`, `ibim_inverse.py` |
| Solver-neutral parameter inverse | `solvers/sdf_inverse/`, [`solver_neutral_inverse.md`](inverse_development_through_2026-09-06.md), `run_sdf_inverse_comparison.py`, `run_sdf_inverse_contour_video.py` |
| Current shape calculus | [`ibim_shape_derivative.md`](../reference/ibim_shape_derivative.md) |
...
| Precision oracle | [`nystrom_reference_study.md`](../reference/nystrom_reference_study.md) |
| Independent FDTD check | [`gprmax_reference_study.md`](../reference/gprmax_reference_study.md) |
| SDF-to-ordered-boundary geometry evidence | [`sdf_boundary_parameterization_implementation.md`](../reference/sdf_boundary_parameterization_implementation.md), `results/sdf_boundary_parameterization/` |
