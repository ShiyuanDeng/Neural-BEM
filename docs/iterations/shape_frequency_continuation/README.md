...
| Review / next decision | **Next: the user's decision on the proposed SC-032** (run SC-031's withheld stage B, the four-stage prefixes for R1/R2, under SC-031's unchanged criteria; ≤ 10,000 units, ≤ 1.5 h). The first-stage objective choice (WP4) follows on the adopted backend. SC-027 is superseded. V2 defaults unchanged; SPD-008 remains the SPD reference |
