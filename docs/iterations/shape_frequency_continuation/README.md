...
| Review / next decision | SPD-L adopted as the comparison reference. **Next, the user's decision on** the proposed **SC-035**, a band-limited hybrid state, which tests the mechanism SC-034 exposes. SC-033 should be re-scoped against SC-035. Both are listed in [iteration 16](iteration_16/01_results.md); neither is approved |
