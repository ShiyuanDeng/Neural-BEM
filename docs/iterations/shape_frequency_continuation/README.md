...
| Item | State |
|---|---|
| Active cycle | [Iteration 14 — SC-031, regularizing metric against the stage-1 collapse](iteration_14/01_results.md) |
| Stage | **SC-031 COMPLETE at its stage-1 gate; hypothesis falsified.** Hanke + L² and Hanke + curvature metrics both leave C/peanut at about 2 mm tightest radius, although the metric was active (λ comparable to G; the curvature term carries 64–89% of the step norm) and ρ ≈ 1. Stages 2–4 were not run. Unplanned observation: R2 fits stage-1 data 3–730× better on C/kite/peanut |
...
| Latest runs | [SC-031 regularizing metric](../../../results/validation/shape_continuation/SC-031-regularizing-metric/README.md), [SC-030 SPD-008 comparison](../../../results/validation/shape_continuation/SC-030-spd008-comparison/README.md), [SC-029 strategy comparison](../../../results/validation/shape_continuation/SC-029-atlas-strategies/README.md), [SC-026 atlas dataset](../../../results/validation/shape_continuation/SC-026-atlas-dataset/ANALYSIS.md), [SC-024](../../../results/validation/shape_continuation/SC-024-backend-ablations/README.md) |
| Review / next decision | **SC-032 APPROVED (user, 2026-09-24: "go"); execution IN PROGRESS** under the [frozen plan](iteration_14/03_plan.md): the four-stage continuation of SC-031's R1/R2 arms from their saved stage-A checkpoints, with SC-031's unchanged criteria, ≤ 10,000 units and ≤ 1.5 h. The first-stage objective choice (WP4) follows on the adopted backend. SC-027 is superseded. V2 defaults unchanged; SPD-008 remains the SPD reference |
