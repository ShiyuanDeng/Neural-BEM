...
| Review / next decision | **Next: the user's decision on the proposed SC-033**, Borges' eq. 13 curvature-tail admissibility filter in the clean hybrid (R0 and R2 arms, stage-1 screen gate, ≈ 30 min, ≤ 10,000 units). It is a literature-grounded candidate repair of the baseline before any WP4/WP5 atlas-policy comparison. Alternatives are recorded in [iteration 15](iteration_15/01_results.md). SPD-008 remains the SPD reference |
