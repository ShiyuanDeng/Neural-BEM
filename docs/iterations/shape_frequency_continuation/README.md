...
| Item | State |
|---|---|
| Active cycle | [Iteration 21 — SC-039 raw boundary data along every saved trajectory](iteration_21/01_results.md), after [iteration 20 — SC-038 update-band release](iteration_20/01_results.md) |
| Stage | **SC-039 COMPLETE, 2026-09-25.** Forward/reciprocal boundary traces, node geometry and full 24x24 predictions at all 19 frequencies on 512/1024 nodes, for all 867 distinct accepted states of 34 trajectories (A–H incl. SC-038 M>9) plus 6 truth references; any first-order atlas is now a contraction with no solves. All integrity checks pass (1,114 saved losses rebuilt bitwise). Data only; no atlas built yet. **SC-038 (previous):** All 19 frequencies with M=11/15/19, K=192: C RMS 0.024100 mm versus matched M=9 0.489494; kite 0.109571 versus 0.551755. Kite required a 768/1536-node replay and remains time-limited, with a spurious sharp feature (minimum sampled radius 0.09078 mm; truth 2.13789). All numerical/provenance audits pass; no method promoted or further run dispatched |
