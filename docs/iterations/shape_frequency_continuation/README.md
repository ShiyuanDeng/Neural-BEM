...
| Item | State |
|---|---|
| Active cycle | [Iteration 15 — SC-032, four-stage continuation of the regularizing-metric arms](iteration_15/01_results.md) |
| Stage | **SC-032 COMPLETE.** R2 (Hanke + curvature metric) improves kite/peanut/C (GM RMS 0.832 vs R0, worst 1.00) but misses the pre-set ≤ 0.8 bar; R1 (Hanke + L²) is worse than R0. The stage-1 collapse (1–2 mm corners) remains under every tested step rule. **R0 stays the baseline**; R2 is opt-in |
...
| Latest runs | [SC-032 four-stage continuation](../../../results/validation/shape_continuation/SC-032-regularizing-metric-prefix/README.md), [SC-031 regularizing metric](../../../results/validation/shape_continuation/SC-031-regularizing-metric/README.md), [SC-030 SPD-008 comparison](../../../results/validation/shape_continuation/SC-030-spd008-comparison/README.md), [SC-029 strategy comparison](../../../results/validation/shape_continuation/SC-029-atlas-strategies/README.md), [SC-026 atlas dataset](../../../results/validation/shape_continuation/SC-026-atlas-dataset/ANALYSIS.md) |
| Review / next decision | **User-requested legacy baseline audit COMPLETE:** [review and reproducible saved-artifact checks](iteration_15/02_proposals/01_legacy_baseline_audit.md). The old topology-free inverse passes all six legacy cases; SC-030 used a different fitter without its physical step cap and regularization. Re-establish baseline recovery parity before interpreting a broad hybrid advantage. SC-033 remains proposed and unexecuted; no successor inverse was run by this audit. SPD-008 remains the execution reference for the fitter it qualified |
