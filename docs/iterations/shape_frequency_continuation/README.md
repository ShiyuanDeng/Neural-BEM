...
| Stage | **SC-031 APPROVED (user, 2026-09-24: "go"); execution IN PROGRESS** under the [frozen plan](iteration_13/03_plan.md). Opt-in Hanke regularizing LM (`damping_rule`, `metric`) with default-bitwise V2; qualification → stage-1 screen (R1 mass, R2 curvature × 6 cases) → gate → stages 2–4. Research brief and [review](iteration_13/02_proposals/02_state_reconciliation_and_SC-031.md) in `iteration_13/02_proposals/`. SC-027 is superseded |
