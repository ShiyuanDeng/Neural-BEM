> Context available before the iteration-2 consultation. This is the full
> completed controls/observability report, not a result of the pending guide.
...
by source hashes in [provenance.json](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/provenance.json). This implements the
[latest directions](../../iteration_01/03_implementation_guides/02_chatgpt_revised_guide.md)
...
[Phase A](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/phase_a/README.md) and [Phases B/C](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/phase_bc/README.md).
...
[physical_jacobian.csv](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/physical_jacobian.csv). The separate
[modal probes](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/modal_jacobian.csv) are constant plus cosine/sine
...
are retained in [the spectra](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/singular_values.csv). Any next
...
rotation value is 0.0481. Full [column correlations](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/column_correlations.csv)
and [spectral plots](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/singular_spectra.png) are available.
...
no hard `kR` cutoff. See [sensitivities](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/sensitivity.png) and the
[observability bundle](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/README.md).
...
[spectrum refinement audit](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/observability/spectrum_refinement.json) bounds changes
...
See [metrics.json](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/metrics.json), [decision_table.csv](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/decision_table.csv),
[commands.txt](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/commands.txt), [provenance.json](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/provenance.json), and
[tests.log](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/tests.log). Generated checkpoints, response/Jacobian arrays, per-weight
