...
> Source run record: [original report](../../../../../results/validation/implicit_mlp_adjoint/latest-direction-20260908/README.md). Numerical claims retain
...
[latest directions](../03_implementation_guides/02_chatgpt_revised_guide.md)
