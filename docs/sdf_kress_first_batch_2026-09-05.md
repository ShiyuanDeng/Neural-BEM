...
[implementation brief](codex_sdf_kress_priorities_2026-09-05.md) are implemented.
...
See the [measured summary](../results/sdf_representation_ablation/saved-star-20260905/summary.md)
and [complete metrics](../results/sdf_representation_ablation/saved-star-20260905/metrics.json).
...
The preceding [short deterministic run](../results/sdf_representation_ablation/short-final-20260905/summary.md)
...
[family index](../results/sdf_representation_ablation/README.md).
...
The [frozen circle/star experiment](../results/smooth_distance_supervision/task-b-circle-star-refined-20260905/README.md)
...
The [bounded measured bundle](../results/parameterization_aware/first-batch-20260905/summary.md)
...
The [decision supplement](../results/parameterization_aware/first-batch-20260905/decision_summary.md)
