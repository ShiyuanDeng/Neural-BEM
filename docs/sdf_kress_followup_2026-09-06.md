...
[guide](codex_sdf_kress_priorities_2026-09-05.md) and historical evidence are
...
The fresh [final sweep](../results/kress_shape_derivative/refined-audits-20260906/summary.md)
...
The first [development sweep](../results/kress_shape_derivative/bounded-20260906/summary.md)
...
The [full evidence and accounting](../results/distance_tangency/first-batch-20260906/README.md)
...
[decision supplement](../results/distance_tangency/first-batch-20260906/decision_supplement.json)
...
The [ten-arm run](../results/neural_metric/comparison-20260906/summary.md)
...
The [eight-arm material batch](../results/material_inverse/bounded-20260906/README.md)
