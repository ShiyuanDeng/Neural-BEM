...
It produced three shared front ends and 15 method rows: 14 `success`, one `fallback`, and zero hard failures. Every reported curve had positive minimum speed and zero sampled self-intersections. The strict artifacts are in [`results/sdf_boundary_parameterization/smoke-20260902/`](../../results/validation/sdf_boundary_parameterization/smoke-20260902): [`manifest.json`](../../results/validation/sdf_boundary_parameterization/smoke-20260902/manifest.json), [`metrics.csv`](../../results/validation/sdf_boundary_parameterization/smoke-20260902/metrics.csv), [`metrics.json`](../../results/validation/sdf_boundary_parameterization/smoke-20260902/metrics.json), 15 native-coefficient/sample NPZ bundles, 15 run records, three front-end bundles, and 15 six-panel plots.
...
are recorded in
[`validation_change_log.md`](../reports/validation_change_log.md#frozen-sdf-boundaries-isolated-scalar-kress-proxy).
