...
class Ledger(p.Ledger):
    ...
    def reserve(self, maximum):
        ...
        stage_spent = self.budget_total-self.stage_budget_start
    ...
    def begin_stage(self, number, quota):
        ...
        self.stage_budget_start = self.budget_total
    ...
    def snapshot(self):
        ...
        row.update(stage=self.stage, stage_attempted=self.total-self.stage_start,
                   stage_work_units=self.budget_total-self.stage_budget_start,
...
def fit_stage(initial, data, nodes, solve, optimizer, floor, ledger, output, step_safeguards=None):
    ...
    def diagnostic(event, payload):
        ...
        if event == 'compiled_backend':
            write(output/'compiled_backend.json', payload)
        elif event == 'jacobian_complete':
