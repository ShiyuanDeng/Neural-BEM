...
def ibim_leading_order_normal_shape_gradient(
    ...
    *,
    ...
    """Return the leading-order normal shape gradient sampled on the implicit boundary."""
    ...
    for sample_index in range(num_samples):
        shape_gradient[sample_index] = _ibim_leading_order_single_sample_normal_gradient_cached(
            context=context,
...
def ibim_multifrequency_leading_order_normal_shape_gradient(
    ...
    *,
    ...
    """Return the weighted multifrequency leading-order normal shape gradient."""
    ...
    shape_gradient = np.zeros((geometry_cache.boundary_points.shape[0],), dtype=float)
    for weight, context in zip(result.frequency_weights, result.per_frequency_contexts):
        shape_gradient += float(weight) * np.asarray(
            [
...
def ibim_bscan_leading_order_normal_shape_gradient(
    ...
    *,
    ...
    """Return the B-scan leading-order normal shape gradient on the implicit boundary."""
