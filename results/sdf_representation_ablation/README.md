...
These runs implement Task A of the 2026-09-05 brief. Historical inverse
bundles under `inverse_solver_comparison/` are unchanged.
...
- `short-20260905/`: retained development result, superseded. It used the
...
The [first-batch report](../../docs/sdf_kress_first_batch_2026-09-05.md)
