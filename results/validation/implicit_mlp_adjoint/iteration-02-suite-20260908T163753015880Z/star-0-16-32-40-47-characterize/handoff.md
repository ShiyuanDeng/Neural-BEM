# Frozen iteration-2 handoff

Stop: `completed_declared_diagnostics`.

| Actual saved state | Diagnostic | Status |
|---|---|---|
| 0 | characterize | completed |
| 16 | characterize | completed |
| 32 | characterize | completed |
| 40 | characterize | completed |
| 47 | characterize | completed |
