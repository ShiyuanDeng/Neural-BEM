...
[probe.py](probe.py) loads the archived initialization vector from [the September 7 metrics](../../../../inverse/implicit_mlp/2026-09-07/ellipse-to-circle/metrics.json), checks its parameter order, and applies the settings parsed from [the September 8 suite record](../../../../inverse/implicit_mlp/2026-09-08/wrong_start_suite.json). It runs geometry construction only: zero pretraining steps, inverse updates, or BEM forward solves. Weights remain exactly unchanged.
