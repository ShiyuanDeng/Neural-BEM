...
def run_multiradial_fd_inverse(
    ...
    *,
    ...
    analytic_constraint_policy: str = "true",
) -> MultiRadialFDResult:
    ...
    # The historical name is retained for experiment wrappers. Analytic mode
    # changes only the residual Jacobian; FD remains the compatibility default.
    if jacobian_mode not in ("fd", "analytic"):
        raise ValueError("jacobian_mode must be 'fd' or 'analytic'.")
