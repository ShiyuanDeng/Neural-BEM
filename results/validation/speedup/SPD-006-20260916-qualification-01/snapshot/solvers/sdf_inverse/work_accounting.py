...
COUNTERS = ('evaluation_count', 'forward_evaluation_count',
            ...
            'compiled_frequency_batch_count', 'compiled_local_factorization_count',
            'compiled_local_rhs_count', 'compiled_local_cache_hit_count',
            'compiled_reduced_solve_count', 'compiled_reduced_rhs_count', 'compiled_fallback_count')
