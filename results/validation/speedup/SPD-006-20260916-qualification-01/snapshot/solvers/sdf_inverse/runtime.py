...
def add_runtime_argument(parser):
    parser.add_argument("--inverse-runtime", choices=tuple(PROFILES), default=None,
        help="fast (default): analytic Cartesian Jacobians and fast CPU kernels; "
             "reference: FD and reference CPU kernels; reciprocal: opt-in reciprocal "
             "Kress shape derivatives; compiled: opt-in reduced Kress for multi-object "
             "Cartesian fits at 256 or more nodes. Inherited by worker processes.")
