...
def test_reference_fd_and_analytic_constraint_policies(monkeypatch):
    ...
    np.testing.assert_array_equal(reference.iterations[0].gradient,fd.iterations[0].gradient)
    np.testing.assert_array_equal(default.iterations[0].gradient,compatible.iterations[0].gradient)
