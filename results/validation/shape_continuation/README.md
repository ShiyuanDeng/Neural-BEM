...
|---|---|
| [SC-026 atlas dataset](SC-026-atlas-dataset/README.md) | Every recorded state (1,286 unique curves, 49 trajectories, 6 cases) × 19 frequencies: Jacobian and residual (P=48), plus evaluation-only layers; reproduces SC-022's blocks to ≤1e-15. [First analysis](SC-026-atlas-dataset/ANALYSIS.md): the determined band scales like the ladder; the next frequency rarely conflicts; data up to 1.25 GHz cannot see most of the near-convergence error; pathological roughening happens only in stage 1. |
