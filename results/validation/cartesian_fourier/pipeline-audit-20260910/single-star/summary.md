...
One-time polar-angle projection of the initial contour: `0.514` mm RMS / `0.853` mm maximum. Accepted increments are re-gauged to polar angle, with band truncation recorded in the trajectory.
