...
|---|---|
| [TOP-009 bandwidth capacity](TOP-009-20260912-bandwidth-capacity/README.md) | Stopped at its stage-2 gate: added shape modes are observable and fit 248x better while boundary error, IoU and holdout error worsen monotonically. Its stage-3 correction showed the truth fits this acquisition to 3.23e-07, and stage 4 ran the ladder to exhaustion at K=9: the answer recovers to 11.849 mm but still ends worse than the circles it started from, 74,159x above the achievable objective. A local minimum, not a data or representation limit |
