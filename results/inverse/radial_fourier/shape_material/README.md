# Explicit Radial Fourier: shape/material variants
...
lessons inform [Implicit MLP + Method B](../../../../docs/pipelines/implicit_mlp.md),
while their measured recovery remains a distinct claim.
See [pipeline details](../../../../docs/pipelines/explicit_radial_shape_material.md) and the [catalogue](../../../README.md).
