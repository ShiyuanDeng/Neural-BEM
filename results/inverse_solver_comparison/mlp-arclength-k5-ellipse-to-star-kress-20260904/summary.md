...
Update basis: modes through `k=5` at `ka = 4.14`. The wave and 12-angle limits are respectively `k=6` and `k=5`.
...
|---|---:|---:|---:|---:|---|
| KRESS | 1.192e+00 -> 4.482e-01 | 1.053e+00 -> 7.568e-01 | 4.203e-02 -> 1.732e-02 m | 82 | `no_acceptable_mlp_distillation` |
